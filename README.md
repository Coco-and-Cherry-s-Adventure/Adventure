...
Google Docs
Game Development
Game Development Link to repository Reflections Iva Catarina
Image
CJ — 6/3/2025 1:55 PM
Hey Iva, I actually might just go and buy a new computer
On a scale from 1-10, how would you classify yours? (Dw, Im asking this to a bunch of people)
Iwa — 6/3/2025 4:15 PM
omgg nouu 😭
Iwa — 6/3/2025 4:15 PM
id say a good 7ish
its nothing too crazy
but i dont have any bad thoughts about it
id say the most important thing is to look for good ram, processor and graphics
or to not look for crazy graphics 😆 cuz that just bumps up the price a lot and if u dont game or do UX then kinda doesn’t matter that much
CJ — 6/3/2025 5:05 PM
Thank you❤️
CJ — 6/4/2025 11:09 PM
Hey girl, just wanted to tell you I am working on the project and Ill update you on what I could do when I cannot more today
Also, Red and Dana asked to join us tomorrow, I dk how you feel about that. Personally I love them, and I think we shoul join Red in the afternoon 100% cause he is also gonna test his game
However, specially when it comes to tight schedules, I would just rather be you and me, what do you think?
CJ — Yesterday at 12:00 AM
I dont know if the health thing is also including the logic, of collectibles, but I got some code for that
Iwa — Yesterday at 2:27 AM
I am completely fine both ways, if they r w us or if we are alone. 
So if u prefer no company we can do just us
Iwa — Yesterday at 2:29 AM
Yess it is. I actually first made the collectibles and then w that the healthbar 
Iwa — Yesterday at 2:40 AM
From my head now, the missing parts of project are:
3rd level setup
magic wand functionality
add the code when u walk left coco and cherry sprite flips and coco is on the right side of her
update drawing of the main sprite of two of them so that Cherry seems like she’s walking
update sprite of them so that Coco seems like is levitating up and down
update sprite so Cherry has the wand in her hand while walking and putting it infront of her w arm out (sword like motion) when she interacts w dangerous fish
make all those animations w all those updated sprites
finish level 4 setup
ai monster
respawn
main/pause menu
i cant think of anything more rn, probably missed something
Ill try to wake around 7:30-8 tomorrow, then be at uni 8:30-9
CJ — Yesterday at 7:25 AM
Got it, Ill be t uni around same time, I would go earlier but there are no buses
CJ — Yesterday at 8:50 AM
do you like this explosion sound?
Iwa — Yesterday at 8:51 AM
i doo
CJ — Yesterday at 9:40 AM
void OnTriggerEnter2D(Collider2D other)
    ...
    private void LevelTransition(Collider2D portal)
    {
        ...
        else if (portal.name == "Level2_portal2")
        {
...
Iwa — Yesterday at 4:16 PM
https://github.com/Coco-and-Cherry-s-Adventure/Adventure/pull/8
GitHub
Pause Menu by iwamucic · Pull Request #8 · Coco-and-Cherry-s-Adve...
Pause menu with options to resume, change volume, change music volume, restart or quit the game. UICanvas with UI image for the pause screen and texts for the options + UI image for the selection a...
Pause menu with options to resume, change volume, change music volume, restart or quit the game. UICanvas with UI image for the pause screen and texts for the options + UI image for the selection a...
Iwa — Yesterday at 4:54 PM
Image
Iwa — Yesterday at 7:58 PM
https://github.com/Coco-and-Cherry-s-Adventure/Adventure/pull/11
GitHub
Level3 setup by iwamucic · Pull Request #11 · Coco-and-Cherry-s-A...
Copied Player, UICanvas, SoundManager, LoadingManager, EventSystems and UIDocument from Level1.
Added a tilemap for level 3. Draw the tilemap of the level.
Add decorations to the level and organise...
Level3 setup by iwamucic · Pull Request #11 · Coco-and-Cherry-s-A...
Iwa — Yesterday at 11:49 PM
https://github.com/Coco-and-Cherry-s-Adventure/Adventure/pull/12
GitHub
Level3 player movement by iwamucic · Pull Request #12 · Coco-and-...
Level3 player movement by iwamucic · Pull Request #12 · Coco-and-...
here is her being able to go through the level, i also added some code to playercontroller so now when u go left the sprite flips and coco is on right side
lemme know when u approve
CJ — 2:01 AM
Image
Image
shit sorry, wrong place
CJ — 12:17 PM
https://github.com/Coco-and-Cherry-s-Adventure/Adventure
GitHub
GitHub - Coco-and-Cherry-s-Adventure/Adventure
Contribute to Coco-and-Cherry-s-Adventure/Adventure development by creating an account on GitHub.
Contribute to Coco-and-Cherry-s-Adventure/Adventure development by creating an account on GitHub.
Iwa — 12:21 PM
...
message.txt
4 KB
Game Development Blog Post #6 – Final Product and Conclusion
Catarina & Iva – June 10th

After months of planning, learning, coding, fixing bugs, and sometimes just staring at Unity in confusion—our game is finally finished!

Our original vision started from a simple Roll-a-Ball tutorial, where a sphere collects objects and avoids enemies. From that small beginning, it grew into a fully playable 4-level 2D adventure platformer starring Cherry, a brave girl, and her adorable cat companion Coco. They travel through a forest, a dark cave, a mysterious underwater world, and a harsh desert, all in a quest to help a lost kitten return home.
Expand
message.txt
5 KB
CJ — 12:49 PM
...
YouTube
Catarina and Iva
Cherry and Coco's Adventure Game
Image
The past week my goal was to finish level 2 and make level 4. When developing level 2, as mentioned in the reflections, I had a lot of difficulties due to what we believe was a mixture of confusing branches and not knowing. This was an issue that followed me until the day before the handin. Despite all- I focused on improving the level 2 design every time I had to reset it. For the level 2, the goal was to give it a cave feel, from the gems and the tnt objects, to the intricate path. 
I also worked on the level transition logic, where I set the portal object so that as soon as the player collides, they would make the scenes change automatically. 
For the last level, the idea was to implement an enemy Ai, which would be the sphinx that now serves as a background. Te pyramid was set to be the portal for the epilogue, a plan that now is archived for future development.
...
My inner animal spirit is a Kirby with a grenade launcher.
Player Movement Tutorial (left, right, jump) - https://www.youtube.com/watch?v=TcranVQUQ5U&list=PLgOEwFbvGm5o8hayFB6skAfa8Z-mw4dPV&index=1
